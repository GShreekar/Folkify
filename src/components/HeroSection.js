          ...
          <div className="space-y-8">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              ...
              <button
                ...
                className="border-2 border-red-600 text-red-700 px-8 py-4 rounded-full text-lg font-semibold hover:bg-red-600 hover:text-white transform hover:scale-105 transition-all duration-200 relative overflow-hidden group"
              >
                <span className="relative z-10 flex items-center justify-center">
                  🏛️ Workshops
                </span>
