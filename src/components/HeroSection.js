...
const FolkArtSlideshow = () => {
  ...
  return (
    <div className="aspect-square bg-gradient-to-br from-red-600 via-orange-500 to-red-800 rounded-2xl flex items-center justify-center relative overflow-hidden shadow-2xl">
      {images.map((image, index) => (
        <div
          key={index}
          className={`absolute inset-4 rounded-xl overflow-hidden transition-opacity duration-1000 ${
        ...
        >
          ...
          <div className="absolute top-2 left-2 w-4 h-4 border-l-2 border-t-2 border-white/40 animate-pulse"></div>
          <div className="absolute top-2 right-2 w-4 h-4 border-r-2 border-t-2 border-white/40 animate-pulse"></div>
          <div className="absolute bottom-2 left-2 w-4 h-4 border-l-2 border-b-2 border-white/40 animate-pulse"></div>
          <div className="absolute bottom-2 right-2 w-4 h-4 border-r-2 border-b-2 border-white/40 animate-pulse"></div>
        </div>
      ))}

      <div className="absolute top-4 left-4 bg-gradient-to-r from-white/20 to-white/10 backdrop-blur-sm rounded-lg px-4 py-2 border border-white/30 shadow-lg animate-pulse">
      ...
      <div className="absolute bottom-4 right-4 bg-gradient-to-r from-amber-500/20 to-red-500/20 backdrop-blur-sm rounded-lg px-4 py-2 border border-white/30 shadow-lg">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div className="space-y-8">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <button
                ...
                className="bg-gradient-to-r from-amber-600 to-red-600 text-white px-8 py-4 rounded-full text-lg font-semibold hover:from-amber-700 hover:to-red-700 transform hover:scale-105 transition-all duration-200 shadow-lg hover:shadow-xl relative overflow-hidden group"
              >
              ...
              <button
                ...
                className="border-2 border-amber-600 text-amber-700 px-8 py-4 rounded-full text-lg font-semibold hover:bg-amber-600 hover:text-white transform hover:scale-105 transition-all duration-200 relative overflow-hidden group"
              >
                <span className="relative z-10 flex items-center justify-center">
                  👨‍🎨 Meet Artists
                </span>
              ...
              <Link
                to="/register"
                className="border-2 border-red-600 text-red-700 px-8 py-4 rounded-full text-lg font-semibold hover:bg-red-600 hover:text-white transform hover:scale-105 transition-all duration-200 relative overflow-hidden group inline-flex items-center justify-center"
              >
                <span className="relative z-10 flex items-center justify-center">
                  ✨ Become an Artist
                </span>
          ...
          <div className="relative">
            <div className={`relative bg-gradient-to-br from-red-800 via-red-700 to-amber-900 rounded-3xl p-8 shadow-2xl transform transition-all duration-1000 ${isVisible ? 'scale-100 opacity-100' : 'scale-95 opacity-0'}`}>
              <FolkArtSlideshow />

              <div className="absolute -top-6 -left-6 bg-gradient-to-r from-yellow-400 to-orange-500 rounded-full px-6 py-3 shadow-xl border-2 border-white animate-float-gentle hover:scale-110 transition-transform duration-300">
                <span className="text-sm font-bold text-white relative">
                  🎨 Warli
                  <div className="absolute inset-0 shimmer-effect rounded-full"></div>
                </span>
              </div>
              <div className="absolute -top-6 -right-6 bg-gradient-to-r from-red-500 to-pink-600 rounded-full px-6 py-3 shadow-xl border-2 border-white animate-float-gentle hover:scale-110 transition-transform duration-300" style={{animationDelay: '0.5s'}}>
                <span className="text-sm font-bold text-white relative">
                  🌺 Madhubani
                  <div className="absolute inset-0 shimmer-effect rounded-full"></div>
                </span>
              </div>
              <div className="absolute -bottom-6 left-1/2 transform -translate-x-1/2 bg-gradient-to-r from-orange-500 to-red-600 rounded-full px-6 py-3 shadow-xl border-2 border-white animate-float-gentle hover:scale-110 transition-transform duration-300" style={{animationDelay: '1s'}}>
                <span className="text-sm font-bold text-white relative">
                  🦚 Pithora
                  <div className="absolute inset-0 shimmer-effect rounded-full"></div>
                </span>
            ...
            <div className="absolute -z-10 top-8 right-8 w-32 h-32 rounded-full opacity-20 animate-pulse">
            ...
            <div className="absolute -z-10 bottom-8 left-8 w-24 h-24 rounded-full opacity-20 animate-bounce-slow">
