    ...
    <section id="explore" className="py-16 folk-art-background relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="text-center">
          <button className="bg-white border-2 border-white text-red-700 px-8 py-4 rounded-full text-lg font-semibold hover:bg-yellow-300 hover:text-red-800 transform hover:scale-105 transition-all duration-200 shadow-lg hover:shadow-xl">
            View All Artworks
          </button>
        </div>
      </div>
